...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma de gerenciamento de salas e créditos para campeonatos de Brawl Stars." },
      { property: "og:title", content: "Diário Brawl Pro" },
      { property: "og:description", content: "Salas, inscrições e saldo R$ para campeonatos de Brawl Stars." },
